...
public:
	...
	MyFrustum(glm::mat4 m);

	// http://iquilezles.org/www/articles/frustumcorrect/frustumcorrect.htm
	bool IsBoxVisible(const glm::vec3& minp, const glm::vec3& maxp) const;
	inline glm::vec3 P(uint p) const
	{
		return m_points[p];
	}
private:
...
inline MyFrustum::MyFrustum(glm::mat4 m)
{
	m = glm::transpose(m);
...
// http://iquilezles.org/www/articles/frustumcorrect/frustumcorrect.htm
inline bool MyFrustum::IsBoxVisible(const glm::vec3& minp, const glm::vec3& maxp) const
{
...
template<MyFrustum::Planes a, MyFrustum::Planes b, MyFrustum::Planes c>
inline glm::vec3 MyFrustum::intersection(const glm::vec3* crosses) const
{
